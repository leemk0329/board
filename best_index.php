   ...
   <nav class="navbar navbar-inverse">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-2">
          <p><strong>HOME&nbsp;&nbsp;<a href="index.php"><i class="glyphicon glyphicon-home"></i></a></strong></p>
          <table class="table-borderless">
            <thead>
              <tr>
                <th width></th>
    ...
    <div class="container">
      <table class="table table-hover">
        <thead>
          ...
          $select_query = "SELECT * FROM board LEFT JOIN good ON board.idx = good.like_num WHERE like_count >= 5";
          ...
          $select_query2 = "SELECT * FROM board LEFT JOIN good ON board.idx = good.like_num WHERE like_count >= 5 order by like_count desc limit $start_num, $list";
